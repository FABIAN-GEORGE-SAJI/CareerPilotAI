...
with col2:
    st.metric(label="ATS Core Engine", value="Deterministic + AI Audit", delta="Baseline scoring, Gemini-refined")
with col3:
...
with c3:
    st.markdown(step_card("03", "📊 ATS Diagnostics", "Receive instant gap analysis, score rationale, and evidence for every matched skill."), unsafe_allow_html=True)
...
<div class="glass">
    ...
    <ul style="color:#A8B8D0; line-height:2; padding-left:20px; margin-bottom:0;">
        ...
        <li><strong style="color:#F8FAFC;">Evidence-Backed Skill Matching:</strong> Every matched skill is tagged explicit or implicit, with the resume phrase that proves it.</li>
